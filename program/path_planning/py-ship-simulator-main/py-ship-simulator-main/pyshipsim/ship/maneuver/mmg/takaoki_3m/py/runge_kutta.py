...
def rk4_mmg(dt, function, time, stateval, n_prop, delta_rudder, wind_velo_true, wind_dir_true):
    ...
    """
    save_intermid = True
    k1 = function(time, stateval, n_prop, delta_rudder,
                  wind_velo_true, wind_dir_true, save_intermid)
    save_intermid = False
...
def rk4_mmg_1p2r(dt, function, time, stateval, n_prop, delta_rudder_s, delta_rudder_p, n_bow_thruster, n_stern_thruster,  wind_velo_true, wind_dir_true):
    """ classical Runge-kutta method subroutine for MMG model
    ...
    """
    save_intermid = True
    k1 = function(time, stateval, n_prop, delta_rudder_s, delta_rudder_p,
                  n_bow_thruster,  n_stern_thruster, wind_velo_true, wind_dir_true, save_intermid)
    save_intermid = False
    k2 = function(time+0.5*dt, stateval + 0.5 * k1 * dt, n_prop,
                  delta_rudder_s, delta_rudder_p, n_bow_thruster,  n_stern_thruster,  wind_velo_true, wind_dir_true, save_intermid)
    k3 = function(time+0.5*dt, stateval + 0.5 * k2 * dt, n_prop,
                  delta_rudder_s, delta_rudder_p, n_bow_thruster,  n_stern_thruster,  wind_velo_true, wind_dir_true, save_intermid)
    k4 = function(time+1.0*dt, stateval + 1.0 * k3 * dt, n_prop,
                  delta_rudder_s, delta_rudder_p, n_bow_thruster,  n_stern_thruster, wind_velo_true, wind_dir_true, save_intermid)
...
def rk4_mmg_1P1R_BTST(dt, function, stateval, delta_rudder, n_prop, n_bt, n_st, wind_dir_true, wind_velo_true):
    ...
    k1 = function(stateval, delta_rudder, n_prop, n_bt,
                  n_st, wind_dir_true, wind_velo_true)
