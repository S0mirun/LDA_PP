...
from ..maneuver.nn import takaoki_3m
...
class Takaoki3mNN(SurfaceShip):
    def __init__(self, solve_method: str = "euler"):
        super().__init__(solve_method)
        self.maneuvering_model = takaoki_3m.NNModel()
        #
...
class Takaoki3mNNWithActuaorResponse(Takaoki3mNN):
